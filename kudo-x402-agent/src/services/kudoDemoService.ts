...
Extract the USDC amount that needs to be repaid. Respond with a JSON object in the following format:
{
  "amount": <number in USDC, e.g., 100 for 100 USDC>
      ...
      const requestUri = ''; // Should I store this as part of the database?
      const requestHash = settlementReceipt.hash; // Generated by me?
      await validateAgent(
        process.env.VALIDATOR_ADDR as Address,
        agentId,
        requestUri,
        requestHash,
      );
